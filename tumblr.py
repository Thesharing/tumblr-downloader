...
class TumblrDownloader:
        ...
        for page in range(start, ceil(total / 20)):
            ...
            for post in self.client.likes(limit=20, offset=page * 20)['liked_posts']:
                ...
                if len(post['trail']) > 1 and not self.reblog:
                    ...
                    logging.info('(Blog) Start post {0} | {1}'.format(post['blog_name'], post['post_url']))
    ...
    def download_blog(self, blog_identifier, start=0):
        ...
        """
        count = 0
        total = self.client.posts(blog_identifier)['total_posts']
    ...
    def _download_file(self, url, file_name):
        ...
        while True:
            ...
            if r.status_code > 400:
                ...
                logging.info('(OK) | {0} | {1}'.format(file_name, url))
